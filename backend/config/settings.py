...
SECRET_KEY = 'django-insecure-%6#3904mxoqw4lo20k7udz)mx9hl@!w40@q#3_-7h6^h_z+u9r'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny', # Se debe cambiar a IsAuthenticated en producción
    ],

...
- El **sidebar** usa iconos **bootstrap-icons** (`bi bi-*`) por compatibilidad con sus estilos; Material Symbols es la librería de iconos del resto de páginas y botones.
